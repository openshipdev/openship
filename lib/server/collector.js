  ...
  await db.transaction(async (tx) => {
    ...
    const [project] = await tx
      ...
      .values({
        ...
        productDescription: manifest.project.productDescription,
        productSummary: manifest.project.productSummary,
        technicalDescription: manifest.project.technicalDescription,
        technicalSummary: manifest.project.technicalSummary,
        metadata,
