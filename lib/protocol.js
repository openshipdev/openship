...
export const documents = [
  ...
  },
  {
    slug: "mcp",
    title: "MCP binding",
    eyebrow: "Optional transport",
    file: "openship-mcp.md",
    summary: "Expose one verified Sources snapshot through a public MCP tool and resources.",
  },
  {
    slug: "changes",
    title: "Changes",
...
export function resolveDocHref(href) {
  ...
  if (document) return `/docs?topic=${document.slug}`;
